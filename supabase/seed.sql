...
on conflict (is_singleton) do update set
  -- The contact identity fields are force-cleared here, not just on first insert.
  -- The schema.sql sample row ships invented contact details ("+1 (555) 010-0000",
  ...
  -- The logo is the one identity field intentionally set: the project's own
  -- Smart Restaurant logo, served from public/logo.jpg.
  restaurant_name = '',
  logo            = '/logo.jpg',
  phone           = '',
  email           = '',
